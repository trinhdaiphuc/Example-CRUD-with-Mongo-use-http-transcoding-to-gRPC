...
var file_entity_proto_rawDesc = []byte{
	...
	0x09, 0x2f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x30, 0x01, 0x42, 0x0a, 0x5a, 0x08,
...
type EntityServiceClient interface {
	...
	ListEntities(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (EntityService_ListEntitiesClient, error)
}
...
func (c *entityServiceClient) ListEntities(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (EntityService_ListEntitiesClient, error) {
...
type EntityServiceServer interface {
	...
	ListEntities(*emptypb.Empty, EntityService_ListEntitiesServer) error
}
...
func (*UnimplementedEntityServiceServer) ListEntities(*emptypb.Empty, EntityService_ListEntitiesServer) error {
